...
$l1 = 2;
while($l1 <= 20){
    echo "$l1-I Love PHP <br>";
    $l1 +=2;
}
echo "<h5>LOOPING 2</h5>";
$l2 = 20;
while($l2 >= 2){
    echo "$l2-I Love PHP <br>";
    $l2 -=2;
}
...
Terdapat data items dalam bentuk array dimensi. Buatlah data tersebut ke dalam bentuk Array Asosiatif. Setiap item memiliki key yaitu : id, name, price, description, source. Output:
